...
$id = $_GET['updateid'];
$sql = "SELECT * FROM `inven` WHERE id='$id'";
...
if (isset($_POST['update'])) {
  ...
  $sql = "UPDATE `inven` SET product='$product', quantity='$quantity' WHERE id='$id'";
  $result = mysqli_query($con, $sql);
  if ($result) {
    ...
    <div class="row">
      <div class="col-lg-4 m-auto">
        <form method="post">
          ...
          <div class="form-group">
            <label>Product</label>
            <input type="text" class="form-control" placeholder="Enter your product" name="product" value="<?php echo $product; ?>" autocomplete="off" readonly>
          </div>
          <div class="form-group">
            <label>Quantity</label>
            <input type="text" class="form-control" placeholder="Enter your quantity" name="quantity" value="<?php echo $quantity; ?>" autocomplete="off" readonly>
          </div>
